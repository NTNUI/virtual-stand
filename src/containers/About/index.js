  ...
  return (
    <Navigation footer>
      ...
      <div className={classes.root}>
        ...
        <p className={classes.text}>NTNUI er Norges teknisk og naturvitenskapelige universitets idrettsforening og har i over 100 år stått for universitetets sportslige tilbud. I motsetning til studentidrettslag i andre land, driftes NTNUI utelukkende av studenter. I dag er NTNUI blitt landets største og mest allsidige idrettsforening med over 14 000 medlemmer og et tilbud på mange flere idretter enn NIF har forbund . «Å få så mange studenter som mulig i fysisk aktivitet og fremme kameratslig samvær» – det var NTNUIs målsetting da organisasjonen ble stiftet i 1910. I dag jobber NTNUI fortsatt for et sunt studentmiljø og for at terskelen for å trene ved NTNU holdes så lav som mulig.</p>
        <p className={classes.text}>Den idrettslige aktiviteten foreningen driver er organisert av de forskjellige gruppene og mange står for mer enn bare én aktivitet, som Dans og Kampsport. Det eksisterer et unikt mangfold blant NTNUIs grupper. Tradisjonelle idretter som fotball, sykling og seiling møter i NTNUI undervannsrugby, rumpeldunk og lacrosse. Har vi ikke din idrett, er det bare å starte den opp.</p>
