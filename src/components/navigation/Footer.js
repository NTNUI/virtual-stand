    ...
    <>
      ...
      <div className={classes.root}>
        <div className={classes.content}>
          <img src={NTNUILOGO} className={classes.logo} alt='NTNUI Logo' />
          <a href='https://ntnui.no/sprint/' target='_noopener' className={classes.sprint}>
            <Typography variant='subtitle1'>Laget med &lt;3 av NTNUI Sprint</Typography>
          </a>
          <a href='https://ntnui.no/' target='_noopener' className={classes.sprint}>
            <Typography variant='subtitle1'>ntnui.no</Typography>
          </a>
        </div>
      </div>
    </>
